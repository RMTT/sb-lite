use crate::handlers::{
    ...
    get_merged_config_handler, get_sing_box_status_handler, list_configs_handler, start_sing_box_handler,
    static_handler, stop_sing_box_handler, update_auto_start_handler, update_config_handler,
...
pub fn create_router(state: AppState) -> Router {
    Router::new()
        ...
        .route("/api/sing-box/auto-start", post(update_auto_start_handler))
