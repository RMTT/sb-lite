use crate::handlers::{
    ...
    start_sing_box_handler, static_handler, stop_sing_box_handler, toggle_auto_start_handler,
    update_config_handler, update_custom_fields_handler, update_subscription_handler,
